  ...
  const [followUps, setFollowUps] = useState([
    {
      ...
      agenda: 'Discuss negotiated pricing tier for 50 enterprise fleet seats',
    },
    {
      id: 'fu_2',
      client_name: 'Elena Rostova',
      company: 'Novatech AI Solutions',
      avatar: 'ER',
      scheduled_date: new Date().toISOString().split('T')[0],
      ...
      agenda: 'Product walkthrough focusing on custom RBAC & automated follow-ups',
    },
    {
      id: 'fu_3',
      ...
      agenda: 'Send revised contract MSA with quarterly payment schedule',
    },
    {
      id: 'fu_4',
      client_name: 'Sophia Patel',
      company: 'GreenLine Health',
      avatar: 'SP',
      scheduled_date: new Date(Date.now() + 86400000).toISOString().split('T')[0],
      ...
      status: 'upcoming',
      assigned_to: 'Sarah Jenkins',
      agenda: 'Confirm receipt of proposal deck and scheduled board meeting date',
    },
    {
      id: 'fu_5',
      client_name: 'Kenneth Clarke',
      ...
      status: 'completed',
      assigned_to: 'Alex Morgan',
      agenda: 'Quarterly review call completed. Upgraded to Annual Pro tier.',
    },
  ]);
