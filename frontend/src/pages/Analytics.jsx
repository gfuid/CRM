...
export default function Analytics() {
  ...
  // Meaningful B2B CRM Enterprise Deals & Contracts
  const [deals, setDeals] = useState([
    {
      id: 'deal_1',
      name: 'Apex Enterprise Cloud License',
      code: '#LIC-88421',
    ...
    {
      id: 'deal_2',
      name: 'Novatech AI Pipeline Platform',
      code: '#NOV-91043',
      category: 'AI Infrastructure',
      client: 'Novatech AI Solutions',
      seats: 12,
      unitPrice: 3200,
      revenue: 38400,
      status: 'Negotiation',
    ...
    {
      id: 'deal_3',
      name: 'HyperScale Security & RBAC Suite',
      code: '#SEC-77312',
      category: 'FinTech Security',
      client: 'HyperScale Cloud Systems',
      seats: 25,
      unitPrice: 1800,
      revenue: 45000,
      status: 'Closed Won',
    ...
    {
      id: 'deal_4',
      name: 'GreenLine Compliance Audit Manager',
      code: '#HLT-44021',
      category: 'Healthcare Suite',
      client: 'GreenLine Health Corp',
      seats: 80,
      unitPrice: 450,
      revenue: 36000,
      status: 'Qualified',
    ...
    {
      id: 'deal_5',
      name: 'Beacon Digital Performance Analytics',
      code: '#BCN-33104',
      category: 'Analytics',
    ...
    {
      id: 'deal_6',
      name: 'Zenith Global Multi-Tenant ERP Sync',
      code: '#ERP-12890',
